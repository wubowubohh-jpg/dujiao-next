...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.update_check_rate_limited":                "更新检查请求次数已超限，请稍后再试",
	...
	LocaleTW: {
		...
		"error.update_check_rate_limited":                "更新檢查請求次數已超限，請稍後再試",
	...
	LocaleEN: {
		...
		"error.update_check_rate_limited":                "Update check rate limit exceeded, please try again later",
